...
export const billingTableConfig = [
    ...
    { uniqueId: 'recourseName', displayName: 'Recourse', sortable: false, dropDownFilter: false, display: true },
    ...
    { uniqueId: 'caseId', displayName: 'Case Id', sortable: false, dropDownFilter: false, display: false },
