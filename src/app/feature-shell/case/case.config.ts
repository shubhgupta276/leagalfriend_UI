export const caseRunningTableConfig = [
  ...
  { uniqueId: 'nextHearingDate', displayName: 'Next Hearing', sortable: false, dropDownFilter: false, display: true },
...
export const caseCompletedTableConfig = [
  ...
  { uniqueId: 'branchName', displayName: 'Branch', sortable: false, dropDownFilter: true, display: false },
  { uniqueId: 'empFirstName', displayName: 'Employee', sortable: true, dropDownFilter: false, display: true },
  { uniqueId: 'nextHearingDate', displayName: 'Next Hearing', sortable: true, dropDownFilter: false, display: false },
  { uniqueId: 'compliance', displayName: 'Compliance', sortable: false, dropDownFilter: false, display: false },
  { uniqueId: 'customerLastName', displayName: 'Customer Last Name', sortable: false, dropDownFilter: false, display: false },
  { uniqueId: 'empLastName', displayName: 'Employee Last Name', sortable: false, dropDownFilter: false, display: false },
  { uniqueId: 'groundForClosingFile', displayName: 'groundForClosingFile', sortable: false, dropDownFilter: false, display: false },
